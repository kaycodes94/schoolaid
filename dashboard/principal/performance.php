...
<head>
  ...
  <title>Performance — School Aid Management System</title>
...
<div class="app-shell">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a href="performance" class="nav-item active" id="nav-performance">
    ...
    <header class="topbar">
      <div class="topbar-left">
        ...
        <div>
          ...
          <div class="page-breadcrumb">Students / <span>Performance</span></div>
        </div>
      </div>
    ...
    <div class="page-content">
      ...
      <div class="stats-grid stats-grid-4 mb-6">
        ...
        <div class="stat-card" style="--stat-color:#f59e0b;--stat-color-bg:rgba(245,158,11,0.12)">
          ...
          <div class="stat-label">Top Student Average</div>
        </div>
      </div>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <select id="termSelect" class="form-control" style="width: 140px; padding: 0.4rem 2.5rem 0.4rem 1rem;">
          ...
          <table class="table">
            <thead>
              <tr>
                ...
                <th>Avg CA Score (40)</th>
                <th>Avg Exam Score (60)</th>
            ...
            <tbody>
              <tr>
                <td><strong>SSS 1</strong></td>
                <td>35</td>
                <td>31.4</td>
                <td>48.2</td>
                <td>79.6%</td>
                <td><span class="badge badge-success">High Performing</span></td>
              </tr>
              <tr>
                <td><strong>JSS 2</strong></td>
                <td>42</td>
                <td>33.8</td>
                <td>51.6</td>
                <td>85.4%</td>
...
<script>
  ...
  function renderSubjectChart() {
    new Chart(document.getElementById('subjectPerformanceChart'), {
      type: 'bar',
      data: {
        labels: ['Maths', 'English', 'Biology', 'Physics', 'Chemistry', 'Arabic', 'Civics'],
        datasets: [{
          label: 'Average Score (%)',
          data: [82, 78, 85, 74, 79, 92, 86],
      ...
      options: {
        ...
        scales: {
          y: { beginAtZero: true, max: 100, grid: { color: 'rgba(148,163,184,0.08)' } },
